...
function setup() {
  ...
  ground = createSprite(200,height-22,400,20);
...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    if(keyDown("space") || touches.length > 0 && trex.y >= 900) {
      trex.velocityY = -12;
    }
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    var cloud = createSprite(width,height-22,40,10);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(width,height-22,400,40);
    //obstacle.debug = true;
